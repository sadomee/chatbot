...
if st.session_state.page == 'home':
    ...
    st.markdown("""
        <div class="tips-layout">
            ...
            <div class="tips-list">
                <div class="instruction-row"><span class="ins-icon">🩺</span><div><b>التعديل الدوائي:</b> لا تبدئي الصيام دون استشارة طبيبك لتعديل جرعات الأنسولين أو الأدوية.</div></div>
